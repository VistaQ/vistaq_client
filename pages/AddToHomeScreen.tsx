...
const AddToHomeScreen: React.FC<Props> = ({ onBack }) => {
  return (
    <div className="max-w-2xl mx-auto space-y-8 pb-8">
      ...
      {/* Intro */}
      <InfoBox>
        Access VistaQ from any browser by visiting{" "}
        <strong>app.vistaq.co</strong>. Once added to your home screen, it opens
        instantly like a native app — no App Store required.
      </InfoBox>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="p-6 space-y-5">
          ...
          <InfoBox>
            You must use <strong>Safari</strong> on iPhone or iPad. Chrome and
            Firefox do not support the 'Add to Home Screen' option on iOS.
          </InfoBox>
          ...
          <div className="space-y-4">
            ...
            <Step number={2} title="Go to app.vistaq.co">
              ...
              <strong>app.vistaq.co</strong>, then tap <strong>Go</strong> on
              your keyboard. Wait for the page to fully load.
            </Step>
            <Step number={3} title="Tap the Share button">
              Tap the <strong>Share icon</strong> at the bottom of the screen.
              It looks like a square with an arrow pointing upward (⬆).
            </Step>
            <Step number={4} title="Select 'Add to Home Screen'">
              ...
              'Edit Actions' at the bottom and add it first.
            </Step>
            <Step number={5} title="Name it 'VistaQ' and tap Add">
              A preview will appear. Make sure the name says{" "}
              <strong>VistaQ</strong>, then tap <strong>'Add'</strong> in the
          ...
          <SuccessBox>
            VistaQ will now appear on your home screen and open fullscreen —
            without the Safari browser bar — just like a native app.
          </SuccessBox>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="p-6 space-y-5">
          ...
          <InfoBox>
            These steps use <strong>Google Chrome</strong>, which is
            recommended. Samsung Internet and Firefox are also supported with
            slightly different menu labels.
          </InfoBox>

          <div className="space-y-4">
            <Step number={1} title="Open Chrome">
              Tap the Google Chrome icon to open the browser on your Android
              device.
            </Step>
            <Step number={2} title="Go to app.vistaq.co">
              Tap the address bar and type <strong>app.vistaq.co</strong>, then
              tap <strong>Go</strong>. Wait for the page to fully load.
            </Step>
            <Step number={3} title="Tap the 3-dot menu (⋮)">
              Tap the three vertical dots in the top-right corner of Chrome to
              open the browser options menu.
            </Step>
            <Step number={4} title="Tap 'Add to Home screen'">
              Look for <strong>'Add to Home screen'</strong> or{" "}
              <strong>'Install App'</strong> in the dropdown menu and tap it. A
              dialog will appear with the app icon and name.
            </Step>
            <Step number={5} title="Name it 'VistaQ' and confirm">
              Confirm the name as <strong>VistaQ</strong> and tap{" "}
              <strong>'Add'</strong> or <strong>'Install'</strong>. The icon
              will appear on your home screen automatically.
            </Step>
          </div>
          ...
          <SuccessBox>
            On some Android devices, Chrome may show an automatic{" "}
            <strong>'Install App'</strong> banner at the bottom of the screen
            when you visit VistaQ — you can tap that directly instead.
          </SuccessBox>
        </div>
      </div>
    </div>
