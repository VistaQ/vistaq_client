              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className={`block w-full bg-gray-50 border text-gray-900 rounded-lg p-2.5 text-sm ${errors.prospect_name ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus-visible:ring-blue-500'}`}
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      onBlur={validateStep1}
                      className={`rounded-none rounded-r-lg bg-gray-50 border text-gray-900 block flex-1 min-w-0 w-full text-sm p-2.5 ${errors.prospect_phone ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus-visible:ring-blue-500'}`}
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    onBlur={validateStep1}
                    className={`block w-full bg-gray-50 border text-gray-900 rounded-lg p-2.5 text-sm ${errors.prospect_email ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus-visible:ring-blue-500'}`}
